...
if (isset($_GET['id'])) {
    ...
    if ($data) {
        ...
        if ($stmt->affected_rows > 0) {
            ...
            echo "<script>alert('Gagal menghapus data!'); window.location = 'galery.php';</script>";
        }
    } else {
        echo "<script>alert('Data tidak ditemukan!'); window.location = 'galery.php';</script>";
    }
} else {
    echo "<script>alert('ID tidak ditemukan!'); window.location = 'galery.php';</script>";
}
