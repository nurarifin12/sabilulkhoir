...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($judul) && !empty($deskripsi) && !empty($gambar)) {
        ...
        if (move_uploaded_file($gambar_tmp, $target_file)) {
            $query = "INSERT INTO galeri (gambar, judul, deskripsi) VALUES  (?, ?, ?)";
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-4">
                        <h1 class="h3 mb-2 text-gray-800">Form Tambah Galeri</h1>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data" class="user m-4">
                            ...
                            <a href="galery.php" class="btn bg-danger text-white ">Kembali</a>
                        </form>
                    </div>
                </div>
